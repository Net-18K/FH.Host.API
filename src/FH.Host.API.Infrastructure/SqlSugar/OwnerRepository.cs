...
namespace FH.Host.API.Infrastructure.SqlSugar
{
    ...
    public class OwnerRepository<T> : IOwnerRepository<T> where T : class, new()
    {
        ...
        {
            return await _dbBase.Queryable<T1, T2>(joinExp).WhereIF(isWhere, whereExp)
        ...
        {
            return await _dbBase.Queryable<T1, T2, T3>(joinExp).WhereIF(isWhere, whereExp).OrderByIF(isOrderBy, orderBy).Select(selectExp).ToListAsync();
        }
        ...
        {
            return await _dbBase.Queryable<T1, T2, T3>(joinExp).WhereIF(isWhere, whereExp).OrderByIF(isOrderBy, orderBy)
        ...
        {
            return await _dbBase.SqlQueryable<T>(sql).ToListAsync();
        }
        ...
        {
            return await _dbBase.Ado.ExecuteCommandAsync(sql, parameters) > 0;
        }
        ...
        {
            return await _dbBase.Ado.SqlQueryAsync<T>(sql, parameters);
        }
        ...
        {
            return await _dbBase.Insertable<T>(list).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Insertable<T>(model).ExecuteReturnIdentityAsync() > 0;//ExecuteReturnBigIdentity();//4.5.0.2 +  long
        }
        ...
        {
            return await _dbBase.Insertable<T>(model).ExecuteReturnEntityAsync();
        }
        ...
        {
            return await _dbBase.Insertable<T>(model).InsertColumns(columns).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Insertable<T>(model)
        ...
        {
            return await _dbBase.Deleteable<T>().In(keys).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Deleteable<T>().Where(where).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Updateable<T>(model).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Updateable<T>(list).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Updateable<T>(model).WhereColumns(expression).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Updateable<T>(model).UpdateColumns(columns).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Updateable<T>(model).IgnoreColumns(columns).ExecuteCommandAsync() > 0;
        }
        ...
        {
            return await _dbBase.Updateable<T>()
        ...
        {
            var able = _dbBase.Updateable<T>(model);
        ...
        {
            return await _dbBase.Ado.UseStoredProcedure().GetDataTableAsync(procedureName, parameters);
        }
        ...
        public async Task<DbResult<bool>> UseTran(Action action, Action<Exception> errorCallBack)
        {
            return await _dbBase.Ado.UseTranAsync(action, errorCallBack); ;
        }
        ...
        /// <param name="errorCallBack">错误回调</param>
        public async Task<DbResult<S>> UseTran<S>(Func<S> func, Action<Exception> errorCallBack)
        {
            return await _dbBase.Ado.UseTranAsync(func, errorCallBack);
        }
